                ...
                <div className="flex items-center gap-4">
                  ...
                  {rideDetails.estimatedFare && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium text-green-600">Estimated Fare: {rideDetails.estimatedFare}</span>
                    </div>
                  )}
                </div>
              </CardContent>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-1">
                            <h4 className="font-medium text-gray-900 truncate">{driver.name}</h4>
                            <Badge
                              className={
                          ...
                          <div className="space-y-1">
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-xs text-gray-600">{driver.completedRides} rides</span>
                            </div>

                            <div className="flex items-center gap-1">
                              <MapPin className="w-3 h-3 text-gray-400" />
                              <span className="text-xs text-gray-600">{driver.location}</span>
                              <span className="text-xs text-gray-400">•</span>
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="text-xs text-gray-600">{driver.vehicle}</span>
                            </div>
