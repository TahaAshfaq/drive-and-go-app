          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="rounded-none shadow-none">
                <CardContent className="p-3 md:p-4">
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-bold text-gray-900">{driver.totalRides}</p>
              ...
              <Card className="rounded-none shadow-none">
                <CardContent className="p-3 md:p-4">
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-bold text-gray-900">{driver.completionRate}%</p>
              ...
              <Card className="rounded-none shadow-none">
                <CardContent className="p-3 md:p-4">
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-bold text-gray-900">{driver.averageResponseTime}</p>
              ...
              <Card className="rounded-none shadow-none">
                <CardContent className="p-3 md:p-4">
                  <div className="text-center">
                    <p className="text-xl md:text-2xl font-bold text-gray-900">{driver.totalDistance}</p>
                    <p className="text-xs md:text-sm text-gray-600">Total Distance</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card className="rounded-none shadow-none">
              <CardHeader>
                <CardTitle className="text-lg md:text-xl">Recent Rides</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {recentRides.map((ride) => (
                    <div
                      key={ride.id}
                      className="flex flex-col sm:flex-row sm:items-center justify-between p-3 md:p-4 border border-gray-200 hover:bg-gray-50 cursor-pointer gap-3"
                      onClick={() => navigateTo("ride-detail", ride)}
                    >
                      <div className="flex-1">
                        <div className="flex items-center gap-2 md:gap-4 mb-2">
                          <span className="font-medium text-gray-900 text-sm md:text-base">{ride.id}</span>
                          <Badge
                            className={
                      ...
                      <div className="text-left sm:text-right">
                        <p className="font-medium text-gray-900 text-sm md:text-base">{ride.amount}</p>
          ...
          <div className="space-y-6">
            ...
            <Card className="rounded-none shadow-none">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900 text-sm md:text-base break-all">{driver.phone}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="w-4 h-4 text-gray-400 flex-shrink-0" />
                  <span className="text-gray-900 text-sm md:text-base break-all">{driver.email}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Calendar className="w-4 h-4 text-gray-400 flex-shrink-0" />
                  <span className="text-gray-900 text-sm md:text-base">Joined {driver.joinDate}</span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="rounded-none shadow-none">
              ...
              <CardContent className="space-y-3">
                <Button
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white rounded-none text-sm md:text-base"
                  onClick={() => navigateTo("ride-allocation", { driverId: driver.id })}
                >
                  Assign Ride
                </Button>
                <Button variant="outline" className="w-full rounded-none bg-transparent text-sm md:text-base">
                  Send Message
                </Button>
                <Button variant="outline" className="w-full rounded-none bg-transparent text-sm md:text-base">
                  View All Rides
